...
syphilis. 
"""
    summaries = ['2012_2RCS_584.pdf']
    
    User('gary.smith@gmail.com', 'Gary', 'Smith').save()
    ...
    Collection("Fred Baker's File", 'Fred has been charged with being too sexy', sample_fact_sheet, summaries, )
